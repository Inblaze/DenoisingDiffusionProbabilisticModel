...
def get_loss(noise_predictor, x, t, diffusion_module):
    noisy_x, noise = diffusion_module(x, t, mode='cosine', tot_steps=300)
...
if __name__ == '__main__':
    ...
    model = torch.load("../saves/2023_10_19_12_41_12.pth")
    model.eval()
    gen = denoise([8, 3, 64, 64], lastT=300, noise_predictor=model,
